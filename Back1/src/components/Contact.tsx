  ...
  const contactMethods = [
    {
      icon: MessageCircle,
      label: "WhatsApp",
      value: "+54 11 7965-2013",
      href: "https://wa.me/541179652013",
      color: "bg-green-100 text-green-600",
    },
    {
      icon: Mail,
      label: "Email",
      value: "info@constelaxio.com",
      href: "mailto:info@constelaxio.com",
    ...
    },
    {
      ...
      label: "Instagram",
      value: "@constelaxio",
      href: "https://instagram.com/constelaxio",
