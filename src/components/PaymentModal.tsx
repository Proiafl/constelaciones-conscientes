...
export const PaymentModal = ({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const paymentEnabled = import.meta.env.VITE_ENABLE_PAYMENT === 'true';

            if (paymentEnabled) {
                // ORIGINAL FLOW: MercadoPago
                ...
                // TEMPORARY BYPASS: Direct booking
            ...
            toast.error(`Error: ${error.message || "Hubo un error al procesar la reserva"}`);
            setIsLoading(false);
        }
    };
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-lg md:max-w-xl transition-all duration-300">
                ...
                <div className="mt-2 min-h-[300px]">
                    ...
                    {/* Step 4: Success (only for bypass mode) */}
                    {step === 4 && (
                        <div className="space-y-6 text-center py-8 animate-in fade-in slide-in-from-right-4 duration-300">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground max-w-md mx-auto">
                                    Pronto me pondré en contacto contigo para confirmar los detalles.
                                    Revisa tu email para ver la invitación al calendario con el link de Google Meet.
                                </p>
                            </div>
